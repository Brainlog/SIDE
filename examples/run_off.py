...
rains1 = ImageCollection(image_path_list=['../images/rain1_INDIA_2017_18_f.tif', '../images/rain2_INDIA_2017_18_f.tif', '../images/rain3_INDIA_2017_18_f.tif', '../images/rain4_INDIA_2017_18_f.tif', '../images/rain5_INDIA_2017_18_f.tif'])
rains2 = ImageCollection(image_path_list=['../images/rain3_INDIA_2017_18_f.tif', '../images/rain4_INDIA_2017_18_f.tif', '../images/rain5_INDIA_2017_18_f.tif'])
loader = Loader()
sr1 = loader.load(sr1)
sr2 = loader.load(sr2)
sr3 = loader.load(sr3)
...
reducer = Reducer()
reduced_rain1 = reducer.reduce_image_collection(rains1.get_image_object_list(), 'mean')
reduced_rain2 = reducer.reduce_image_collection(rains2.get_image_object_list(), 'mean')
